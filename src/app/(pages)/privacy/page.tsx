...
export const metadata: Metadata = {
  title: "プライバシーポリシー - Tomokichiのポートフォリオ",
  description: "Tomokichiのポートフォリオサイトのプライバシーポリシーページです。",
};
  ...
  return (
    <div className="mx-auto max-w-4xl p-4">
      <section className="mb-12 text-center">
        <h1 className="mt-6 text-4xl font-bold text-foreground">プライバシーポリシー</h1>
      </section>
      ...
      <section className="prose prose-lg max-w-none dark:prose-invert prose-p:leading-relaxed">
        ...
        <h2 className="text-2xl font-bold mt-8">第4条（アクセス解析ツールについて）</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold mt-8">第5条（プライバシーポリシーの変更について）</h2>
        <p>
