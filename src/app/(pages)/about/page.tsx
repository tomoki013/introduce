  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <section className="mb-12 flex flex-col items-center text-center">
        ...
        />
        <h1 className="mt-6 text-4xl font-bold text-slate-900 dark:text-slate-50">
          Tomokichi
        </h1>
        <p className="mt-2 text-lg text-sky-500 dark:text-sky-400">
          新しい世界への探究心を、技術で形にする。
        </p>
      </section>
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 border-l-2 border-sky-500 pl-6 dark:border-sky-400">
          <div className="mb-6">
            <h3 className="font-bold">プログラミング学習を開始</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400">XXXX年</p>
          </div>
          <div className="mb-6">
      ...
      <section className="mt-16 text-center">
        ...
        <Link
          href="/skills"
          className="mt-6 inline-block rounded-md bg-sky-500 px-6 py-3 font-bold text-white transition-transform hover:scale-105"
        >
          スキル一覧へ
        </Link>
      </section>
